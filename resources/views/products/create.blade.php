  ...
  <div class="col-lg-10">
    <div class="card fade-in">
      <div class="card-body p-5">
        <h3 class="fw-bold mb-4"><i class="bi bi-plus-circle me-2"></i>Tambah Produk Baru</h3>
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">@csrf
          <div class="row g-4">
            <div class="col-md-6">
              ...
              <input type="text" name="name" class="form-control form-control-lg" placeholder="Contoh: Air Mineral 600ml" required>
            </div>
            <div class="col-md-3">
              <label class="form-label fw-semibold"><i class="bi bi-upc me-2"></i>SKU</label>
              <input type="text" name="sku" class="form-control form-control-lg" placeholder="AM600" required>
            </div>
            <div class="col-md-3">
              <label class="form-label fw-semibold"><i class="bi bi-cash me-2"></i>Harga (Rp)</label>
              <input type="number" name="price" class="form-control form-control-lg" min="0" step="0.01" placeholder="5000" required>
            </div>
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="pack_size" class="form-control form-control-lg" min="1" value="1" required>
              <small class="text-muted">Contoh: 12 pcs per kardus</small>
            </div>
            <div class="col-md-3">
              <label class="form-label fw-semibold">Label Pack</label>
              <input type="text" name="pack_label" class="form-control form-control-lg" value="pcs" required>
            </div>
            <div class="col-md-3">
              <label class="form-label fw-semibold"><i class="bi bi-stack me-2"></i>Jumlah Pack Awal</label>
              <input type="number" name="initial_packs" class="form-control form-control-lg" min="0" value="0" placeholder="10">
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="discount_value" class="form-control form-control-lg" min="0" step="0.01" value="0">
            </div>
            <div class="col-md-6">

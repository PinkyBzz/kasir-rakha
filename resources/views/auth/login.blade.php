    ...
    <div class="card fade-in" style="border-radius: 24px; overflow: hidden;">
      <div class="card-body p-5">
        <div class="text-center mb-4">
          <div style="width: 80px; height: 80px; background: var(--primary-gradient); border-radius: 50%; margin: 0 auto 1rem; display: flex; align-items: center; justify-content: center;">
        ...
        <form method="POST" action="{{ route('login.post') }}">@csrf
          ...
          <button class="btn btn-primary w-100 py-3 mb-3" style="font-size: 1.1rem;">
